...
env DEBUG=*:* LANYON_ONLY="system" LANYON_PROJECT=$HOME/code/content npm run build

env DEBUG=*:* LANYON_ONLY="rbenv" LANYON_PROJECT=$HOME/code/content node lib/cli.js install
env DEBUG=*:* LANYON_ONLY="rbenv" LANYON_PROJECT=$HOME/code/content npm run build

env DEBUG=*:* LANYON_ONLY="rvm" LANYON_PROJECT=$HOME/code/content node lib/cli.js install
env DEBUG=*:* LANYON_ONLY="rvm" LANYON_PROJECT=$HOME/code/content npm run build

env DEBUG=*:* LANYON_ONLY="docker" LANYON_PROJECT=$HOME/code/content node lib/cli.js install
env DEBUG=*:* LANYON_ONLY="docker" LANYON_PROJECT=$HOME/code/content npm run build

# env DOCKER_BUILD=1 DEBUG=*:* LANYON_ONLY="docker" LANYON_PROJECT=$HOME/code/content node lib/cli.js install
# env DOCKER_BUILD=1 DEBUG=*:* LANYON_ONLY="docker" LANYON_PROJECT=$HOME/code/content npm run build
