      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 26:
            ...
            _context.next = 32;
            return scrolex.exe('cd .lanyon && docker build' + cache + ' -t kevinvz/lanyon:' + runtime.lanyonVersion + ' .');

          case 32:
            _context.next = 34;
            return scrolex.exe('cd .lanyon && docker push kevinvz/lanyon:' + runtime.lanyonVersion);
          ...
          case 59:
            ...
            _context.next = 67;
            return scrolex.exe(oneLine(_templateObject, runtime.cacheDir, deps.ruby.exe, deps.gem.exe, localGemArgs, deps.bundler.preferred, deps.ruby.exeSuffix, deps.ruby.exeSuffix));
