...
# for dir in ~/code/team-interals ~/code/invig ~/code/content ~/code/kvz.io ~/code/legal ~/code/lanyon/example ~/code/lanyon/website ~/code/transloadify ~/code/tus.io ~/code/frey-website ~/code/bash3boilerplate; do
for dir in ~/code/team-interals
  pushd "${dir}"
